...
function buildDemoDashboard() {
  const certBund = [
    { title: '[hoch] Cisco IOS XE: Mehrere Schwachstellen ermöglichen Codeausführung', date: iso(0, 8) },
    { title: '[kritisch] Ivanti Connect Secure: Schwachstelle ermöglicht Umgehung der Authentisierung', date: iso(0, 7) },
    { title: '[hoch] Linux-Kernel: Mehrere Schwachstellen ermöglichen Privilegieneskalation', date: iso(1) },
    { title: '[mittel] OpenSSL: Schwachstelle ermöglicht Denial of Service', date: iso(1, 14) },
    { title: '[hoch] Microsoft Exchange Server: Schwachstelle ermöglicht Codeausführung', date: iso(2) },
    { title: '[hoch] VMware ESXi: Mehrere Schwachstellen ermöglichen Ausbruch aus der VM', date: iso(2, 16) },
    { title: '[mittel] Mozilla Firefox: Mehrere Schwachstellen', date: iso(3) },
    { title: '[hoch] Fortinet FortiOS: Schwachstelle ermöglicht Codeausführung', date: iso(4) },
    { title: '[mittel] GitLab: Mehrere Schwachstellen ermöglichen Offenlegung von Informationen', date: iso(5) },
  ...
  return {
    ...
    lists: {
      ...
      world,
      socialTrends: [
        { tag: 'KRITIS', count: 3400, source: 'Mastodon' },
        { tag: 'ZeroDay', count: 2850, source: 'Mastodon' },
        { tag: 'AIAct', count: 2100, source: 'Mastodon' },
        { tag: 'Ivanti', count: 1900, source: 'Mastodon' },
        { tag: 'OpenSource', count: 1450, source: 'Mastodon' },
        { tag: 'Verwaltungscloud', count: 980, source: 'Mastodon' },
        { tag: 'Ransomware', count: 760, source: 'Mastodon' },
        { tag: 'Quantencomputer', count: 540, source: 'Mastodon' },
        { tag: 'Cyberabwehr EU', count: null, source: 'Bluesky' },
        { tag: 'KI in Behörden', count: null, source: 'Bluesky' },
        { tag: 'Souveräne Cloud', count: null, source: 'Bluesky' },
        { tag: 'Post-Quantum', count: null, source: 'Bluesky' },
      ],
    },
    sources: [
